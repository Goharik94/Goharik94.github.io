						...
						<div class="sidebar_wrap">
							...
							<div class="recent-detail">
								<div class="recent-image">
									<a href="#"> <img src="<?php bloginfo('template_url'); ?>/images/recent_img1.png" alt="image"> </a>
								</div> 
							...
							<div class="recent-detail">
								<div class="recent-image">
									<a href="#"> <img src="<?php bloginfo('template_url'); ?>/images/recent_img2.png"  alt="image"> </a>
								</div> 
							...
							<div class="recent-detail">
								<div class="recent-image">
									<a href="#"> <img src="<?php bloginfo('template_url'); ?>/images/recent_img3.png" alt="image"> </a>
								</div> 
							...
							<div class="recent-detail">
								<div class="recent-image">
									<a href="#"> <img src="<?php bloginfo('template_url'); ?>/images/recent_img4.png"  alt="image"> </a>
								</div> 
						...
						<div class="sidebar_wrap">
							...
							<div class="category-detail">
								 <ul>	
									...
									<li> <a href="<?php bloginfo('template_url'); ?>/music.php""> <i class="fa fa-folder-open-o" aria-hidden="true"></i> Music <span> 16 </span> </a> </li>
