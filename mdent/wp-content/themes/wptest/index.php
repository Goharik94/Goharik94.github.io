			...
			<div class="col-md-12">
				<div class="top_banner">
						<div class="category_m">
							...
							<a href="http://vampire-faceliftuk.co.uk/"><button style="colo">Href Page</button></a>
						</div>
        	...
        	<div class="col-md-8">
				<article class="blog_post">
					<h4> <a href="#"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. </a> </h4>
						...
						<div class="blog_post_img">
							<a href="#"> <img src="<?php bloginfo('template_url'); ?>/images/blog_post_img1.png" alt="image"> </a>
						</div>
				...
				<article class="blog_post">
					<h4> <a href="#"> There are many variations of passages of Lorem Ipsum available. </a> </h4>
						...
						<div class="blog_post_img">
							<a href="#"> <img src="<?php bloginfo('template_url'); ?>/images/blog_post_img2.png"  alt="image"> </a>
						</div>
				...
				<article class="blog_post">
					<h4> <a href="#"> All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks </a></h4>
						...
						<div class="blog_post_img">
							<a href="#"><img src="<?php bloginfo('template_url'); ?>/images/blog_post_img3.png"  alt="image"> </a>
						</div>
